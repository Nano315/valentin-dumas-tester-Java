...
public class ParkingService {
    ...
    public void processIncomingVehicle() {
        try {
            ...
            if (parkingSpot != null && parkingSpot.getId() > 0) {
                ...
                // 3) Enregistrer le ticket en base
    ...
    public void processExitingVehicle() {
        try {
            ...
            // 1) Vérifier si c’est un utilisateur récurrent
            int nbTicket = ticketDAO.getNbTicket(vehicleRegNumber);
            boolean discount = (nbTicket > 1);

            // 2) Calculer le tarif avec ou sans réduction
            fareCalculatorService.calculateFare(ticket, discount);

            // 3) Mettre à jour le ticket en base
